      ...
      <RadioCard.Item value="free">
        <Flex justify="between" align="center" width="100%">
          <Box>
            ...
            <Text color="slate">Up to 3 projects</Text>
          </Box>
      ...
      <RadioCard.Item value="pro">
        <Flex justify="between" align="center" width="100%">
          <Box>
            ...
            <Text color="slate">Unlimited projects & priority support</Text>
          </Box>
