...
import type { PittoricaAppearance } from '../../types';
import { Box, type BoxProps } from '../Box';
import { PittoricaTheme, type ThemeAppearance } from '../PittoricaTheme';
...
export const PopoverContent = <E extends ElementType = 'div'>({
  ...
  useIsomorphicLayoutEffect(() => {
    if (isOpen && refs.domReference.current) {
      ...
      if (themeElement) {
        const app = themeElement.dataset.appearance as PittoricaAppearance;
